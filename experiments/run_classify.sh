...
# make -C .. -j
user_home="$HOME"
# python3 run.py --verbose --force --filter="classify_160-resnet18_v1-vta-qt-rtl-4-160" --force pyexps/classify_simple.py --repo $(user_home)/SimBricks-LPN/ & 
# python3 run.py --verbose --force --filter="classify_160-resnet34_v1-vta-qt-rtl-4-160" --force pyexps/classify_simple.py --repo $(user_home)/SimBricks-LPN/ & 
# python3 run.py --verbose --force --filter="classify_160-resnet50_v1-vta-qt-rtl-4-160" --force pyexps/classify_simple.py --repo $(user_home)/SimBricks-LPN/ &

python3 run.py --verbose --force --filter="classify_160-resnet18_v1-vta-gem5_o3-rtl-4-200" --force pyexps/classify_simple.py --repo $(user_home)/SimBricks-LPN/ & 
python3 run.py --verbose --force --filter="classify_160-resnet34_v1-vta-gem5_o3-rtl-4-200" --force pyexps/classify_simple.py --repo $(user_home)/SimBricks-LPN/ & 
python3 run.py --verbose --force --filter="classify_160-resnet50_v1-vta-gem5_o3-rtl-4-200" --force pyexps/classify_simple.py --repo $(user_home)/SimBricks-LPN/ &
