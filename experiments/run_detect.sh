...
#python3 run.py --verbose --force --filter="detect_simple_lpn_cpu-vta-gem5_o3-2000" --force pyexps/detect_simple.py --repo $(user_home)/SimBricks-LPN/

python3 run.py --verbose --force --filter="detect_t-vta-qemu_icount-lpn-160" --force pyexps/detect_simple.py --repo $(user_home)/SimBricks-LPN/
# python3 run.py --verbose --force --filter="detect-vta-gem5_o3-rtl-200" --force pyexps/detect_simple.py --repo $(user_home)/SimBricks-LPN/

#python3 run.py --verbose --force --filter="detect_simple-vta-qk-2000" --force pyexps/detect_simple.py --repo $(user_home)/SimBricks-LPN/
